...
/* package haskell-super-auto-pets-0.1.0.0 */
#ifndef VERSION_haskell_super_auto_pets
#define VERSION_haskell_super_auto_pets "0.1.0.0"
#endif /* VERSION_haskell_super_auto_pets */
#ifndef MIN_VERSION_haskell_super_auto_pets
#define MIN_VERSION_haskell_super_auto_pets(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_super_auto_pets */
...
#define CURRENT_PACKAGE_KEY "haskell-super-auto-pets-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "haskell-super-auto-pets-0.1.0.0-inplace"
